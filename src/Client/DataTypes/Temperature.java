...
public class Temperature {
    ...
    public Temperature(){
        ...
        if(number>=0 && number<=0.01){
            celsius = new BigDecimal(random.nextDouble()*1 + 38.7).setScale(1, RoundingMode.HALF_UP).doubleValue();
        }

        // Probability of getting heat between 36-37
        else if(number>0.01&&number<=30) {
        ...
        else if(number>30&&number<99.99) {
